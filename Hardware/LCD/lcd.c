...
{  
	...
	HAL_DMA_Start(&hdma_memtomem_dma2_stream1, Color_Buffer, &LCD->RAM, Width * Height); // I LOVE DMA LOL :D
	HAL_DMA_PollForTransfer(&hdma_memtomem_dma2_stream1, HAL_DMA_FULL_TRANSFER, 30);
}  
//画线
//x1,y1:起点坐标
//x2,y2:终点坐标  
